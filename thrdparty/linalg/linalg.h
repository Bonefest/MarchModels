...
const double ONE_PI  = 3.14159265;
const double HALF_PI = 1.57079632;
const double TWO_PI  = 6.28318507;

template <typename T>
inline T toRad(T deg) { return (deg / 180.0) * ONE_PI; }

template <typename T>
inline T toDeg(T rad) { return (rad / ONE_PI) * 180.0; }
